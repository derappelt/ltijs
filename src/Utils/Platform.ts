...
class Platform {
   ...
   */
  async platformClientId (): Promise<string> {
   ...
   * @param {string} [name] - Platform name.
   */
  async platformName (name?: string): Promise<string> {
   ...
   */
  async platformKid (): Promise<string> {
    return this.#kid
  }
   ...
   */
  async platformActive (active?: boolean): Promise<boolean> {
    if (active === undefined) {
      // Get platform status
   ...
   */
  async platformPublicKey (): Promise<string> {
   ...
   */
  async platformPrivateKey (): Promise<string> {
   ...
   */
  async platformAuthConfig (method?: AuthConfig['method'], key?: string): Promise<AuthConfig> {
   ...
   */
  async platformAuthenticationEndpoint (authenticationEndpoint?: string): Promise<string> {
   ...
   */
  async platformAccessTokenEndpoint (accesstokenEndpoint?: string): Promise<string> {
   ...
   */
  async platformAuthorizationServer (authorizationServer?: string): Promise<string> {
   ...
   */
  async platformAccessToken (scopes: string): Promise<AccessTokenResponse> {
   ...
   */
  async platformJSON (): Promise<Record<string, unknown>> {
    const platformJSON = {
      id: this.#kid,
   ...
   * @deprecated
   */
  async platformAuthEndpoint (authenticationEndpoint?: string): Promise<string> {
